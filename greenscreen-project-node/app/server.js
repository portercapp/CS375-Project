    ...
    upload(req, res, function(err) {
        ...
        if (req.fileValidationError) {
            ...
            if (req.body['bg-radio'] !== undefined) {
                res.send(
                    `You have uploaded this profile image: <hr/><img src="${req.files[`profile_pic`][0].filename}" width="500"><hr /><a href="./">Upload another image</a>
                    <br/>You have selected this background image: <hr/><img src="${req.body['bg-radio']}.jpg" width="500"><hr /><a href="./">Upload another image</a>`
                    );
            }else{
            ...
            res.send(
                `You have uploaded this profile image: <hr/><img src="${req.files[`profile_pic`][0].filename}" width="500"><hr /><a href="./">Upload another image</a>
                 <br/>You have uploaded this background image: <hr/><img src="${req.files[`background_pic`][0].filename}" width="500"><hr /><a href="./">Upload another image</a>`
